...
def main(limit=6000, x_limit=2, y_limit=2): #changing the x_limit and y_limit to bigger words
    """执行程序
    Args:
    ...
    print('extract lines')
    fp = open(r'Finest(0-360,482-722,chatterbot)20190721.conv', 'r', encoding='utf-8')
    last_line = None
    groups = []
    group = []
    for line in tqdm(fp):
